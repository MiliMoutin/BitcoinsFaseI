...
CajitaView::drawCajita(Cajita* caja)
{
	...
	al_draw_filled_rectangle(30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(255, 255, 255));
	al_draw_rectangle(30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x-30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0), 1);
	al_draw_text(font, al_map_rgb(0, 255, 0), 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, caja->getFrom().c_str());

	al_draw_text(font, al_map_rgb(0, 255, 0), x+30, (C_DISPLAY_H / 2) - TEXTSIZE + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, "To:");
	al_draw_filled_rectangle(x + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x * 2 - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(255, 255, 255));
	al_draw_rectangle(x+30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x*2-30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0), 1);
	al_draw_text(font, al_map_rgb(0, 255, 0), x + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, caja->getTo().c_str());

	al_draw_text(font, al_map_rgb(0, 255, 0), x*2+30, (C_DISPLAY_H / 2) - TEXTSIZE + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, "Amount:");
	al_draw_filled_rectangle(x * 2 + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x * 3 - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(255, 255, 255));
	al_draw_rectangle(x*2+30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x*3-30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0), 1);
	al_draw_text(font, al_map_rgb(0, 255, 0), x*2 + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, caja->getAmount().c_str());
