...
CajitaView::drawCajita(Cajita* caja)
{
	...
	al_draw_filled_rectangle(30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0));
	...
	al_draw_filled_rectangle(x + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x * 2 - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0));
	...
	al_draw_filled_rectangle(x * 2 + 30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x * 3 - 30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0));
	al_draw_rectangle(x*2+30, (C_DISPLAY_H / 2) + N_DISPLAY_H, x*3-30, (C_DISPLAY_H / 2) + TEXTSIZE + N_DISPLAY_H, al_map_rgb(0, 0, 0), 1);


	al_draw_text(font, al_map_rgb(0, 255, 0), (DISPLAY_W/2) - (TEXTSIZE*2), (C_DISPLAY_H / 2) - TEXTSIZE + N_DISPLAY_H, ALLEGRO_ALIGN_LEFT, "SEND");
